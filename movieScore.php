...
switch($web){
	case 'meta':
		...
		echo "<h3>meta</h3>";
		echo "<a href='https://www.metacritic.com/movie/$movieName'>visit metacritic $movieName</a><br>";
	...
	case 'rotten':
		...
		echo "<h3>rotten</h3>";
		echo "<a href='https://www.rottentomatoes.com/m/$movieName'>visit rottentomatoes $movieName</a><br>";
	...
	case 'imdb':
		...
		$movieScore=json_decode($movieScore_json,true);
		echo "<h3>imdb</h3>";
		printf("<a href='%s'>visit imdb %s</a><br>",$movieScore['imdb_url'],$movieName);
